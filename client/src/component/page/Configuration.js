...
const Configuration = (props) => {
  ...
  const [ mainSectionContent, setMainSectionContent ] = useState(() => EditorState.createEmpty());
    ...
    >
      <Form form={form} onFinish={handleSubmit} layout="vertical">
        ...
        <Row gutter={24}>
          ...
          {/* <Col>
            <Form.List name="shippingFeeRanges" label="Shipping Fee Ranges">
              {
                (fields, { add, remove }) => {
                  return (
                    <div>
        ...
        {/* <div style={{height: '100px', border: "1px solid blue"}}>
          <Editor placeholder="Enter some text..." editorState={mainSectionContent} onChange={setMainSectionContent} />
